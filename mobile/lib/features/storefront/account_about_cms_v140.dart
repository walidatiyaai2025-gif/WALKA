...
import '../information/information_v102.dart'
    show WalkaAmazonStoreV102, WalkaSocialV102;

class WalkaAccountCmsV140 extends StatelessWidget {
  const WalkaAccountCmsV140({required this.onFavorites, super.key});
            ...
            child: LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                ...
                final Widget productSupport = WalkaAccountProductSupportGroup(
                  ...
                  onOurStory: () => _push(context, const WalkaAboutCmsV140()),
                  onFaq: () => _push(context, const WalkaFaqCmsV140()),
                  onContact: () => _push(context, const WalkaContactCmsV140()),
                );
                ...
                final Widget legal = WalkaAccountLegalAppGroup(
                  onPrivacy: () => _push(
                    context,
                    const WalkaLegalCmsV140(
                      type: WalkaLegalTypeCmsV140.privacy,
                    ),
                  ),
                  onTerms: () => _push(
                    context,
                    const WalkaLegalCmsV140(
                      type: WalkaLegalTypeCmsV140.terms,
                    ),
                  ),
                  onAppInfo: () =>
                ...
                return CustomScrollView(
                  key: const PageStorageKey<String>('walka-cms-account-scroll'),
                  slivers: <Widget>[
                    SliverToBoxAdapter(
                      child: Align(
...
class WalkaAboutCmsV140 extends StatelessWidget {
  const WalkaAboutCmsV140({super.key});

  @override
  Widget build(BuildContext context) {
    final WalkaAboutContent about =
        WalkaContentScope.maybeOf(context)?.information.content.about ??
            WalkaInformationContent.bundled.about;

    final Widget hero = WalkaAboutHero(
      eyebrow: about.heroEyebrow,
      title: about.heroTitle,
      body: about.heroBody,
    );
    final Widget story = WalkaAboutStoryIntro(
        ...
        child: LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            ...
            return SingleChildScrollView(
              key: const PageStorageKey<String>('walka-cms-about-scroll'),
              padding: EdgeInsets.fromLTRB(
                gutter,
                18,
                gutter,
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      const SizedBox(height: 28),
                      WalkaAboutClosing(
                        eyebrow: about.closingEyebrow,
                        title: about.closingTitle,
                        body: about.closingBody,
                      ),
                    ],
                  ),
                ),
