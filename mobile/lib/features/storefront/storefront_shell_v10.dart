...
class WalkaStorefrontSplashV10 extends StatelessWidget {
  const WalkaStorefrontSplashV10({super.key});
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(
                  width: 320,
                  child: Text(
                    'A refined product experience with fullscreen galleries, variant transitions, share tools and direct Amazon purchase handoff.',
                    style: TextStyle(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute<void>(
                        builder: (_) => const WalkaStorefrontShellV10(),
                      ),
                    );
                  },
...
class WalkaStorefrontShellV10 extends StatefulWidget {
  const WalkaStorefrontShellV10({super.key});

  @override
  State<WalkaStorefrontShellV10> createState() =>
      _WalkaStorefrontShellV10State();
}

class _WalkaStorefrontShellV10State extends State<WalkaStorefrontShellV10> {
  int _index = 0;
