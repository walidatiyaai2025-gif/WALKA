...
class WalkaApiHealth {
  ...
  factory WalkaApiHealth.fromJson(Map<String, dynamic> json) {
    ...
    return WalkaApiHealth(status: requiredString('status'), service: requiredString('service'), release: requiredString('release'), apiVersion: requiredString('api_version'));
  }
}
