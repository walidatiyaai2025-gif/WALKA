    ...
    ->group(function (): void {
        ...
        Route::middleware('walka.dashboard')->group(function (): void {
            ...
            Route::get('/media', [AdminMediaController::class, 'index'])
                ...
                ->name('media.index');
            Route::post('/media/uploads', [AdminMediaController::class, 'store'])
                ->middleware('walka.dashboard.can:media.upload')
                ->name('media.store');
            ...
            Route::put('/media/galleries/products/{product}', [AdminMediaGalleryController::class, 'updateProduct'])
                ->middleware('walka.dashboard.can:media.assign')
            ...
            Route::post('/media/replacements', [AdminMediaReplacementController::class, 'store'])
                ->middleware('walka.dashboard.can:media.replace')
            ...
            Route::get('/audits', [AdminDashboardController::class, 'audits'])
                ->middleware('walka.dashboard.can:audits.view')
                ->name('audits');
