...
Route::prefix('admin')
    ...
    ->group(function (): void {
        ...
        Route::middleware('walka.dashboard')->group(function (): void {
            ...
            Route::patch('/media/galleries/products/{product}', [AdminMediaGalleryController::class, 'updateProduct'])
                ->name('media.galleries.products.update');
            Route::patch('/media/galleries/variants/{variant}', [AdminMediaGalleryController::class, 'updateVariant'])
                ->where('variant', '.*')
