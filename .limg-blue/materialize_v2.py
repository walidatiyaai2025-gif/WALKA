...
SOURCE = Path('Images/main new(3).jpg')
ALPHA = Path('/tmp/finalmask_alpha.png')
...
EXPECTED_ALPHA_SHA = '25fec27db0b5b10012b3a9a5d0227ea5d2ed92c7046844c0ed9a97329fa5680b'
...
def main() -> None:
    ...
    assert sha256(ALPHA) == EXPECTED_ALPHA_SHA, 'approved alpha-mask fingerprint mismatch'
